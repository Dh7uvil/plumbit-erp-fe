...
| `inventory-management`  | **Implemented:** units, categories, products, price-lists, warehouses, stock (balances + `/stock-movements`), stock-transfers, stock-adjustments, goods-receipts, quality-inspections. **Planned:** delivery-notes, sales-returns.                                                                                                                                                    |
...
│   │   │                             goods-receipts/ quality-inspections/
