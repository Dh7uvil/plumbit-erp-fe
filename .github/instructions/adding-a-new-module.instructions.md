...
| `crm`                   | **Implemented:** customers, contacts, pipelines, lead-sources, lost-reasons, leads, opportunities, activities, notes, campaigns, reports (flat `/reports/sales-pipeline` and related CRM report paths gated by `reports.report.crm`). **Planned:** none.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
│   │   │                             leads/ opportunities/ activities/ notes/ campaigns/ reports/
...
Keep `/landed-costs` unique. Keep `/activity` (users-management audit feed) distinct from
