...
export default function CostCenterDetailEditPage({ params }: { params: Promise<{ id: string }> }) {
  return (
    <DetailPageRoute
      params={params}
      permission={costCenterPermissions.update}
      notFoundMessage="Cost center not found."
    >
      {(id) => <CostCenterDetailScreen termId={id} mode="edit" />}
    </DetailPageRoute>
  );
}
