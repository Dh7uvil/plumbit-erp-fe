...
export function DayBookRows({
  ...
  return lines.map((line, index) => {
    const sticky =
      line.row_type === "opening" || line.row_type === "closing" || line.row_type === "day_total";
    return (
      <TableRow
      ...
      >
        ...
        <TableCell>
          {line.row_type === "movement" || line.row_type === "day_total" ? money(line.debit) : "—"}
        </TableCell>
        <TableCell>
          {line.row_type === "movement" || line.row_type === "day_total" ? money(line.credit) : "—"}
        </TableCell>
...
export function CashBankBookScreen({
  bookKind,
  title,
  subtitle,
  exportSlug,
            ...
            {reportQuery.isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={showAccountColumn ? COLUMN_COUNT : COLUMN_COUNT - 1}>
                  <DataTableEmpty
                    title="No activity"
                    message="No posted cash or bank lines in this period."
                  />
                </TableCell>
              </TableRow>
            ) : (
