...
const HEADERS = ["Name", "Category", "Rate", "Default", "Status", "Actions"] as const;
const ALL = "all";
      ...
      <DataTable footer={meta ? <DataTablePagination meta={meta} onPageChange={setPage} /> : null}>
        ...
        <TableBody>
          {taxesQuery.isLoading ? (
            ...
            <TableRow>
              <TableCell colSpan={HEADERS.length}>
                <DataTableEmpty title="No taxes" message="Create a tax to get started." />
              </TableCell>
            </TableRow>
          ) : (
            rows.map((tax) => (
              <TableRow key={tax.id}>
                ...
                <TableCell>{TAX_CATEGORY_LABELS[tax.tax_category]}</TableCell>
