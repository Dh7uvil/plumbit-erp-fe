...
export const SalesOrderSchema = z.object({
  ...
  expected_shipment_date: z.string().nullable(),
...
export const SalesOrderComposeDefaultsSchema = z.object({
  customer_id: z.string().uuid(),
...
export type SalesOrderComposeDefaults = z.infer<typeof SalesOrderComposeDefaultsSchema>;
...
export const SalesOrderUpdateRequestSchema = z.object({
  contact_id: z.string().uuid().nullable().optional(),
  branch_id: z.string().uuid().nullable().optional(),
  warehouse_id: z.string().uuid().nullable().optional(),
  order_date: z.string().nullable().optional(),
...
export function isBlankSalesOrderLine(line: SalesOrderLineFormValues): boolean {
