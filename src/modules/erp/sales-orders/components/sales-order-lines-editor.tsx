...
import type {
  ...
  SalesOrderLineFormValues,
} from "@/modules/erp/sales-orders/schemas";
import { DISCOUNT_TYPE_LABELS, DISCOUNT_TYPES } from "@/modules/erp/sales-orders/schemas";
...
export function emptySalesOrderLine(): SalesOrderLineFormValues {
  return {
    ...
    <div className="flex flex-col gap-2">
      ...
      {disabled ? null : (
        <Button
          ...
          variant="outline"
          size="sm"
          onClick={() => append(emptySalesOrderLine())}
        >
