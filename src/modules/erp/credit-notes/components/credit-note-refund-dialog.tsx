...
import { useRefundCreditNote } from "@/modules/erp/credit-notes/mutations";
...
export function CreditNoteRefundDialog({
  note,
  open,
  onOpenChange,
}: {
  ...
  async function onSubmit() {
    ...
    try {
      ...
      toast.success("Unapplied credit refunded");
      onOpenChange(false);
    } catch (error) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Refund unapplied credit</DialogTitle>
          <DialogDescription>
            Pay out {formatMoney(note.amount_unapplied, currencyCode)} from this credit note to a cash or bank
            account. AR will decrease and the payment account will credit.
          </DialogDescription>
        </DialogHeader>
