...
export const TenantCurrentSchema = z.object({
  ...
  fiscal_year_start_day: z.number().int().min(1).max(31).default(1),
  books_start_date: z.string().nullable().optional(),
...
export const TenantCurrentUpdateSchema = z.object({
  ...
  fiscal_year_start_day: z.number().int().min(1).max(31).nullable().optional(),
  books_start_date: z.string().nullable().optional(),
  acknowledge_fiscal_year_change: z.boolean().optional(),
  ...
  allow_negative_cash: z.boolean().nullable().optional(),
